...
export default class Firebase {
    ...
    addMessage = async (message) => {
        ...
        return await this._messagesDb.collection('messages').add({
            author,
            createdAt,
            message,
        });
    ...
    setMessagesListener = (listener) => this._messagesDb.dollection('messages').orderBy('createdAt', 'desc').limit(10).onSnapshot(listener);
